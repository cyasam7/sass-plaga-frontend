export const FIELD_REQUIRED = 'Este campo es requerido';
export const AT_LEAST_ONE_OPTION = 'Este campo debe tener al menos una opción';
export const FIELD_EMAIL_VALID = 'Coloca un correo electrónico valido.';
